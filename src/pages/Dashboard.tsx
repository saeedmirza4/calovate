                        ...
                        <div className="relative w-full h-full">
                          <div className="absolute inset-0" style={{ 
                            background: `conic-gradient(
                              #60a5fa ${(totalNutrition.protein * 4 / totalNutrition.calories || 0) * 360}deg, 
                              #facc15 0 ${((totalNutrition.protein * 4 + totalNutrition.carbs * 4) / totalNutrition.calories || 0) * 360}deg,
                              #a855f7 0
                            )` 
                          }}></div>
                        </div>
